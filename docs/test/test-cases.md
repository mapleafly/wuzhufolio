...
| TC-MAN-02 开机自启 | Windows 11 | ⏳ **阻塞（打包版启动失败）** | 第十轮 · 2026-09-15 | 步骤 1–2 正常；**步骤 3 双击安装版图标弹「Failed to launch JVM」→ DEF-42（P1，定性中）**；排查与绕行见 `manual-test-guide.md §16`、取证脚本 `scripts/diagnose-packaged-launch.ps1` |
...
> **剩余 4 项**：TC-MAN-01（待明确判定）、TC-MAN-02（**待复验：DEF-42 已按 D34 修复**，见 `manual-test-guide.md §16`）、
> TC-MAN-09（未执行）、**TC-MAN-11（新增：便携版解压即用 · D34 产物）**。
